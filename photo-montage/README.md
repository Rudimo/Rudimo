...
> **Прод-версия:** в [`service/`](service/) — HTTP API + веб-интерфейс с выбором
> нейросети (OpenRouter / прямой Gemini), Docker-деплой, интеграция с postim.life.
> Ниже — исходный CLI-скрипт для ручного прогона.
